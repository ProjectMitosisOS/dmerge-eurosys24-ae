...
SD = sopen() if PROTOCOL in ['DMERGE', 'DMERGE_PUSH', 'ESRDMA', 'MITOSIS'] else 0
eager_fetch = 0
import redis

# Note: We must use connection pool to avoid bottleneck!!!
...
# Create a Redis client instance with the connection pool
